...
func (*S) TestLoadConfig(c *check.C) {
	...
	os.Setenv("IMAGE_PLANS", `[{"image":"memcached:1","plan":"memcached_1","args":["-m", "1024"]},{"image":"memcached:1.3","plan":"memcached_1_3"}]`)
